...
<script type="text/javascript" src="<%=path%>/js/pages/people/supplies.js"></script>
<title>供应商</title>
<style>
   	...
   	<div region="center" id="centers" style="width:100%; height: 100%;">
	   	<div class='tf-toolbar' id="toolbar"></div>
			<table id="dg" class="easyui-treegrid" style="width:100%;height:88.5%;"
				rownumbers="true" idField="suppliesId" treeField="suppliesName">
				<thead>
					<tr>
						<th field="touse" align="center" width="100px" formatter="format">操作</th>
						<th field="suppliesId" width="5%"  hidden="true">供应商ID</th> 
						<th field="suppliesName" width="250px">供应商名称</th>
						<th field="supSuppliesId" width="5%"  hidden="true">上级供应商ID</th>
						<th field="supSuppliesName" width="150px">上级供应商名称</th>
		...
		<form id="fm" method="post"  style="padding: 25px 40px">
		    <div class="dataGet">
				<div class="dataGet_contents">
					...
					<input id="suppliesName" name="suppliesName" class="easyui-textbox" style="margin-top: 5px;"  style="width:210px"/>
				</div>
				<div class="dataGet_contents">
					<label>
						<p class="symbol floatLeft"></p>
					...
					<input id="supSuppliesName" name="supSuppliesName" class="easyui-combotree" style="margin-top: 5px"/>
				</div>
			</div>
			...
			<div class="dataGet">
				<div class="dataGet_contents">
					...
					<input id="enterpriseType" name="enterpriseType" class="easyui-textbox" style="margin-top: 5px;"  style="width:210px"/>
				</div>
				<div class="dataGet_contents">
					<label>
						<p class="symbol floatLeft">*</p>
					...
					<input id="legalPerson" name="legalPerson" class="easyui-textbox" style="margin-top: 5px"/>
				</div>
			</div>
			...
			<div class="dataGet">
				<div class="dataGet_contents">
					...
					<input id="detailAddress" name="detailAddress" class="easyui-textbox" style="margin-top: 5px;"  style="width:210px"/>
				</div>
				<div class="dataGet_contents">
					<label>
						<p class="symbol floatLeft">*</p>
					...
					<input id="phoneNumber" name="phoneNumber" class="easyui-textbox" style="margin-top: 5px"/>
				</div>
			</div>
			...
			<div class="dataGet">
				<div class="dataGet_contents">
					...
					<input id="taxRegistration" name="taxRegistration" class="easyui-textbox" style="margin-top: 5px;"  style="width:210px"/>
				</div>
				<div class="dataGet_contents">
					<label>
						<p class="symbol floatLeft">*</p>
					...
					<input id="bankName" name="bankName" class="easyui-textbox" style="margin-top: 5px"/>
				</div>
			</div>
			...
			<div class="dataGet">
				<div class="dataGet_contents">
					...
					<input id="bankNumber" name="bankNumber" class="easyui-textbox" style="margin-top: 5px;"  style="width:210px"/>
				</div>
				<div class="dataGet_contents">
					<label>
						<p class="symbol floatLeft"></p>
					...
					<input id="remark" name="remark" class="easyui-textbox" style="margin-top: 5px"/>
				</div>
			</div>
		</form>
	</div>
		...
		<form id="customerfm" method="post" >
			<div class="dataGet">
				<div class="dataGet_contents">
					...
					<input id="suppliesName" name="suppliesName" class="easyui-textbox" style="margin-top: 5px;"  style="width:210px" readonly="readonly"/>
				</div>
				<div class="dataGet_contents">
					<label>
						<p class="symbol floatLeft"></p>
					...
					<input id="supSuppliesName" name="supSuppliesName" class="easyui-combotree" style="margin-top: 5px" readonly="readonly"/>
				</div>
			</div>
